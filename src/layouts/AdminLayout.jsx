...
import { Home, Users, Settings, Menu, BarChart2 } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const nav = [
    ...
    { to: '/user-profile', label: 'User Profile', icon: <BarChart2 size={18} /> },
    ...
    <div className="flex h-screen">
      ...
      >
        <div className="flex items-center justify-between p-3 border-b">
          ...
          <button onClick={() => setCollapsed((s) => !s)} className="p-1 text-gray-600">
            <Menu size={16} />
          </button>
        </div>
